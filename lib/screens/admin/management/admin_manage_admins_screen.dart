...
class _ManageAdminsScreenState extends State<ManageAdminsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Kelola Admin', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold, color: Colors.white, fontSize: 18)),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _showForm ? Colors.grey[300] : AppColors.adminPrimary,
          ...
          Container(
            ...
            child: Center(
              child: Text(
                ...
                style: const TextStyle(color: AppColors.adminPrimary, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),
              ),
            ),
          ),
  ...
  InputDecoration _inputDeco(String label, IconData icon) => InputDecoration(
    ...
    prefixIcon: Icon(icon, size: 18, color: AppColors.adminPrimary),
    border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.grey[300]!)),
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: AppColors.adminPrimary)),
