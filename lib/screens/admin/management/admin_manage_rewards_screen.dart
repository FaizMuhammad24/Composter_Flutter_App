...
class _ManageRewardsScreenState extends State<ManageRewardsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Kelola Rewards', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold, color: Colors.white, fontSize: 18)),
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.card_giftcard_outlined, size: 18), text: 'Katalog'),
            Tab(icon: Icon(Icons.pending_actions_outlined, size: 18), text: 'Klaim'),
          ],
        ),
      ),
      body: TabBarView(
        ...
        children: [
          Row(
            children: [
              ...
              _buildMiniStat('Total Poin', '${_rewards.fold<int>(0, (int sum, RewardModel r) => sum + r.points)}', Colors.amber[700]!),
              const SizedBox(width: 8),
              Expanded(
