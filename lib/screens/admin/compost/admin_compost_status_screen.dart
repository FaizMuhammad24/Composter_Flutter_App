...
class _AdminCompostStatusScreenState extends State<AdminCompostStatusScreen> {
  ...
  Widget _buildBatchTimerCard() {
    return Container(
      ...
      child: Row(
        children: [
          Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: AppColors.adminPrimary.withValues(alpha: 0.1), shape: BoxShape.circle), child: const Icon(Icons.timer, color: AppColors.adminPrimary, size: 24)),
          ...
          Container(
            ...
            child: Text('Hari $_daysSinceStart', style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.adminPrimary, fontFamily: 'Poppins')),
          ),
        ],
      ),
    );
