...
class _AdminCategoryHumidityScreenState extends State<AdminCategoryHumidityScreen> {
  ...
  Future<void> _loadData() async {
    ...
    _historyData = MockSensorHistory.getHumidityHistory(_selectedPeriod);
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: Text('${_currentValue.toStringAsFixed(1)}%', style: const TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                            ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(_currentValue < 30 ? 'AKTIF (ON)' : 'MATI (OFF)', style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                                    ],
                                  ),
                                ),
                                Container(
                                  ...
                                  child: Text(
                                    _currentValue >= 30 && _currentValue <= 60 ? 'Ideal' : (_currentValue < 30 ? 'Kering' : 'Basah'),
                    ...
                    const Text('Historis Kelembaban', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                        ...
                        children: ['24 Jam', '7 Hari', '30 Hari'].map((period) {
                          ...
                          return Padding(
                            ...
                            child: FilterChip(
                              ...
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20), side: BorderSide(color: isSelected ? const Color(0xFF2196F3) : Colors.transparent)),
                            ),
                          );
                        }).toList(),
                      ),
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Grafik Kelembaban', style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                            const SizedBox(height: 24),
                            SizedBox(
                              height: 200,
                              child: LineChart(
                                LineChartData(
                                  ...
                                  extraLinesData: ExtraLinesData(
                                    horizontalLines: [
                                      HorizontalLine(y: 60, color: Colors.orange.withOpacity(0.5), strokeWidth: 1, dashArray: [5, 5], label: HorizontalLineLabel(show: true, labelResolver: (line) => 'Batas Atas', style: const TextStyle(color: Colors.orange, fontSize: 10))),
                                      HorizontalLine(y: 30, color: Colors.orange.withOpacity(0.5), strokeWidth: 1, dashArray: [5, 5], label: HorizontalLineLabel(show: true, labelResolver: (line) => 'Batas Bawah', style: const TextStyle(color: Colors.orange, fontSize: 10))),
                                    ],
                                  ),
                                  lineBarsData: [
                                    LineChartBarData(
                                      ...
                                      belowBarData: BarAreaData(
                                        ...
                                        gradient: LinearGradient(
                                          colors: [const Color(0xFF2196F3).withOpacity(0.3), const Color(0xFF2196F3).withOpacity(0.0)],
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Statistik & Info', style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Poppins')),
                            const SizedBox(height: 16),
                            _buildStatRow('Range Ideal', '30% - 60%'),
                            const Divider(),
                            _buildStatRow('Rata-rata', '${_calculateAvg().toStringAsFixed(1)}%'),
                            const Divider(),
                            _buildStatRow('Pompa Runtime', '34 menit hari ini'),
                            const Divider(),
                            _buildStatRow('Alert Kering', '${_historyData.where((e) => e.value < 30).length} kejadian'),
                          ],
                        ),
                      ),
                    ),
