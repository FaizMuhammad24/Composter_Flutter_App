              ...
              children: [
                Container(
                  ...
                  child: const CircleAvatar(
                    ...
                    child: Icon(Icons.admin_panel_settings, size: 60, color: AppColors.adminPrimary),
                  ),
                ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildStatColumn('Sistem', '5 Sensor', Colors.blue),
                        Container(height: 40, width: 1, color: Colors.grey[200]),
                        _buildStatColumn('Alert', '3 Aktif', Colors.red),
                      ],
                    ),
                  ),
  ...
  Widget _buildMenuTile({
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(
          color: isDestructive ? Colors.red.withValues(alpha: 0.1) : Colors.orange.withValues(alpha: 0.05),
          shape: BoxShape.circle,
        ),
  ...
  void _showLogoutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'Apakah kamu yakin ingin keluar dari aplikasi admin?',
