...
class _AdminCategoryTemperatureScreenState extends State<AdminCategoryTemperatureScreen> {
  ...
  double _thresholdMin = 60.0;
  double _thresholdMax = 65.0;
  ...
  void _listenToFirebase() {
    ...
    _rtdbSubLive = FirebaseDatabase.instance.ref('komposter').onValue.listen((event) {
      if (event.snapshot.value != null && mounted) {
        ...
        final double thMax = (tempTh?['max'] as num?)?.toDouble() ?? 65.0;
        ...
        setState(() {
          ...
          _currentValue = (stale || failed) ? 0.0 : tempVal;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SensorHistoryToggle(
                          ...
                          sensorLabel: 'Suhu', unit: '°C', color: Colors.deepOrange,
