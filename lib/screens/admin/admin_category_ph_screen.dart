                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SensorHistoryToggle(
                          ...
                          minY: 0, maxY: 14, thresholdMin: 6.0, thresholdMax: 8.0,
                        ),
                        const SizedBox(height: 20),
                        // Statistik
                        Card(elevation: 2, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                          child: Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            const Divider(),
                            _buildStatRow('Pompa EM4 Aktif', _isOffline ? 'Terputus' : (_em4PumpStatus ? 'Ya' : 'Tidak')),
                          ]))),
                        const SizedBox(height: 20),
                        SensorCalibrationCard(sensorKey: 'ph', sensorLabel: 'pH', unit: '', color: const Color(0xFF9C27B0), defaultMin: 6.0, defaultMax: 8.0),
                      ],
                    ),
                  ),
                ),
